...
export const AppContextProvider = ({children})=> {
    ...
    //Function to get user applications data
    ...
    useEffect(()=>{
        fetchJobs()
        //whenever recruiter reloads the webpage , the do not get logged out because token is stored in the local storage of web browser
