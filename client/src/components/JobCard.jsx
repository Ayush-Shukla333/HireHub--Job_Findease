  ...
  return (
    <div className='border-gray-300 border-2 px-5 py-2 rounded hover:shadow-lg transition-shadow duration-300'>
      ...
      <div className='flex gap-3 mt-4'>
        <button className='bg-blue-500 text-white px-3 py-1.5 rounded cursor-pointer hover:bg-blue-900'>Apply Now</button>
        <button className='text-gray-900 border border-gray-400 px-4 py-1.5 rounded cursor-pointer hover:bg-gray-200'>Learn More</button>
      </div>
    </div>
  )
}
